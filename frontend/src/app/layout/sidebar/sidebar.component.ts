...
@Component({
  ...
  template: `
    <aside class="fixed left-0 top-[72px] h-[calc(100vh-72px)] border-r border-[#1e293b] bg-[#0b1329] flex flex-col transition-all duration-300 ease-in-out z-40 overflow-hidden shadow-xl"
  ...
  styles: [`
    ...
    /* Custom Webkit scrollbar for the sidebar navigation scroll area */
    ...
    aside:hover nav::-webkit-scrollbar-thumb {
      background: rgba(148, 163, 184, 0.15); /* Fades in when sidebar is hovered */
    }
    nav::-webkit-scrollbar-thumb:hover {
      background: rgba(59, 130, 246, 0.5) !important; /* Active blue glow when thumb hovered */
    }
  `]
})
